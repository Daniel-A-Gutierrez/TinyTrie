...
use super::PrefixLen;
use super::prefix_trie::{align_up,  Trie};
...
impl<const INLINE: usize, PREFIX: PrefixLen> PairVec<INLINE, PREFIX> {
    ...
    pub fn find_child(&self, byte: u8) -> Option<usize> {
        super::simd::hnode_find_child(self.ptr, self.len as usize, byte)
    }
    ...
    pub fn find_child_lower_bound(&self, byte: u8) -> usize {
        super::simd::hnode_find_child_lower_bound(self.ptr, self.len as usize, byte)
    }
}
