    ...
    M: Mode<T>,
{
    ...
    fn get_mut(&mut self, ptr: P) -> LeafNodeMut<T, P, F, M, MIN, MAX> {
        todo!()
    }

    fn get_node(&self, ptr: P, idx: usize) -> &Option<T> {
        todo!()
    }

    fn get_node_mut(&mut self, ptr: P, idx: usize) -> &mut Option<T> {
        todo!()
    }
    ...
    fn insert(&mut self, position: P, size: usize, budget: usize) {
        todo!()
    }
