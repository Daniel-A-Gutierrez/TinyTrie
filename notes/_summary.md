...
Previews are a ~24% lookup regression vs linear scan (5.38M→6.65M). Binary search is worst of all (3.88M) — each comparison derefs a Box<[u8]>, destroying cache locality. Linear scan wins for short varlen keys at N=16.